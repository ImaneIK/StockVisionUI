const Toggle = ({ selectedModel,handleModelChange}) => {
    return(
        <nav className="flex flex-nowrap w-full text-center">
            <button
              className={`bg-blue-700 inline-flex w-full items-center h-10 xl:h-[8vh] px-4 -mb-px text-[2.5vh] text-center whitespace-nowrap inline-flex py-2 px-3 text-sm font-medium transition-all duration-50 ease-in-out ${
